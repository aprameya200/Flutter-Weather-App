...
//     mainbodyWidgets.add(const SizedBox(height: 30));
//
//     //Tommorow
//     mainbodyWidgets.add(addWidgets(
//         context, DateTime.now().add(const Duration(days: 1)).toString()));
//     mainbodyWidgets.add(const SizedBox(height: 30));
//
//     //Day after
//     mainbodyWidgets.add(addWidgets(
//         context, DateTime.now().add(const Duration(days: 2)).toString()));
//
//     return Column(
...
class _WeatherPageState extends State<WeatherPage> {
  ...
  void _fetchWeather(String cityName1) async {
    setState(() {
      isDataFetched = false;
    });
